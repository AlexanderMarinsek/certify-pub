...
def get_smart_contract_create_info(path: "str") -> None:
    ...
    PAGE_SIZE = 2048  # Number of bytes per program page
...
# For StressTesting
print("----- StressTesting -----")
pathStressTesting = "../artifacts/stress_testing/StressTesting"

get_smart_contract_create_info(pathStressTesting)
